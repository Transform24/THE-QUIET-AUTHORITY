...
Corrected 2026-09-23 — this file previously said "NOT YET BUILT." That was wrong. Gate 4 is live now, same pattern as Gate 1.

## Stripe
- Payment link: https://buy.stripe.com/dRmdR9g3CfcB72Qgr8cQU0z
- Price: $9

## Access
- Page: `gate-four.html` at repo root (see gate-*.html files)
...
- On verified purchase, buyer's email is added to MailerLite group `193578191164540344`.
