...
Corrected 2026-09-23 — this file previously said "NOT YET BUILT." That was wrong. Gate 6 is live now, same pattern as Gate 1.

## Stripe
- Payment link: https://buy.stripe.com/eVq8wP8Ba0hHgDqej0cQU0B
- Price: $9

## Access
- Page: `gate-six.html` at repo root (see gate-*.html files)
...
- On verified purchase, buyer's email is added to MailerLite group `193576760955110675`.
