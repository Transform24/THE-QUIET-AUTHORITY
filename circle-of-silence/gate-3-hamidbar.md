...
Corrected 2026-09-23 — this file previously said "NOT YET BUILT." That was wrong. Gate 3 is live now, same pattern as Gate 1.

## Stripe
- Payment link: https://buy.stripe.com/9B600j9FefcB0EscaScQU0y
- Price: $9

## Access
- Page: `gate-three.html` at repo root (see gate-*.html files)
...
- On verified purchase, buyer's email is added to MailerLite group `193578269634725820`.
